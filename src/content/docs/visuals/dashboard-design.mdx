...
- **Buttons:** Use verb‑first labels like "Investigate churn" or "Open pipeline detail". Refer to our [Button guidelines](/components/actions/button/) for guidance on colour and copy.
...
- **Buttons:** Use verb‑first labels like "Investigate churn" or "Open pipeline detail" for buttons and navigation items. Refer to our [Button guidelines](/components/actions/button/) for guidance on colour and copy.
